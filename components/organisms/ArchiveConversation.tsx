    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2 max-h-60 overflow-y-auto">
        {archivedConversations.map((conversation) => {
          ...
          return (
            <div key={conversation.id} className="p-3 rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 transition-colors">
              ...
              <div className="flex items-center justify-between text-xs text-slate-400">
                <span>{conversation.updatedAt instanceof Date ? conversation.updatedAt.toLocaleDateString("en-US") : ""}</span>
                <span className="flex items-center gap-1">
